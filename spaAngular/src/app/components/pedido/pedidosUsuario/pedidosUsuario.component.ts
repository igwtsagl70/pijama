...
@Component({
  ...
  templateUrl: './pedidosUsuario.component.html',
  styleUrls: ['./pedidosUsuario.component.css'],
...
export class PedidosUsuarioComponent implements OnInit {
  ...
  constructor(
    ...
    buscar(): void {
      ...
      var user = this.identityUserService.getUserUser();
      alert(user);
      this.pedidoService.getPedidosUsuario(user, this.palabra, sFechaInicial, sFechaFinal, this.page, "").subscribe(
          res => {
